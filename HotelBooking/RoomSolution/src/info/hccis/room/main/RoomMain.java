...
import info.hccis.room.bo.SpecialBoardRoom;
import info.hccis.room.util.RoomUtil;
import info.hccis.room.util.RoomUtility;
        ...
        while (selection != 7) {
            ...
            switch (selection) {
                ...
                case 4:
                    ...
                    break;
                case 5:
                    RoomUtility.CountRoomsAndDisplayStat(rooms);
                    break;
                case 6:
                    RoomUtility.searchRoom(rooms);
                    break;
                case 7:
